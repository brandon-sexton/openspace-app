...
content_column = dbc.Col(
    [
        ...
        dbc.InputGroup(
            [
                dbc.Input(id='target-input-x', type='number', value=42164, persistence=True, style={'width':'16.666%'}),
                ...
                dbc.Input(id='target-input-vy', type='number', value=3.074, persistence=True, style={'width':'16.666%'}),
